...
if ( ! function_exists ( 'sktm_maintenance_mainmenu_callback' ) ) {
	function sktm_maintenance_mainmenu_callback(){
		global $wpdb;
		$mode = sanitize_text_field(isset($_REQUEST['mode']) ? $_REQUEST['mode'] : '');
		...
		<form method="post" enctype="multipart/form-data" action="options.php">
    		...
    		<table class="skt-maintenance-options-table">
    			...
    			<tr>
    				...
    				<td><input type="text" name="site_title_color" class="color-field"  value="<?php echo $site_title_color; ?>"></td>
    			</tr>
    			<tr>
    				<td><?php esc_attr_e('Site Title Font Size','skt-maintenance'); ?></td>
    				<td><input type="number" name="site_title_font_size" value="<?php echo $site_title_font_size;?>" placeholder="<?php esc_attr_e('Enter site title font size without px','skt-maintenance'); ?>"></td>
    			</tr>
    			<tr>
    			...
    			<tr>
    				...
    				<td><input type="text" name="heading_color" class="color-field"  value="<?php echo $heading_color; ?>"></td>
    			</tr>
    			<tr>
    				<td><?php esc_attr_e('Headline Font Size','skt-maintenance'); ?></td>
    				<td>
            		<input type="number" name="headingfont_size" value="<?php echo $headingfont_size; ?>" placeholder="<?php esc_attr_e('Enter headline font size without px','skt-maintenance'); ?>">
    				</td>
    			</tr>
    			<tr>
				...
				<tr>
					<td><?php esc_attr_e('Set Logo Width'); ?></td>
					<td><input type="number" name="logo_width" value="<?php if($logo_width !=''){echo $logo_width;} ?>" placeholder="<?php esc_attr_e('Enter logo width without px','skt-maintenance'); ?>"></td>
				</tr>
				<tr>
					<td><?php esc_attr_e('Set Logo Height'); ?></td>
					<td><input type="number" name="logo_height" value="<?php if($logo_height !=''){echo $logo_height;}?>" placeholder="<?php esc_attr_e('Enter logo height without px','skt-maintenance'); ?>"></td>
				</tr>
    			...
    			<tr>
    				...
    				<td><input type="text" name="description_color" class="color-field"  value="<?php echo $description_color; ?>"></td>
    			</tr>
    			<tr>
    				<td><?php esc_attr_e('Description Font Size','skt-maintenance'); ?></td>
    				<td><input type="number" name="descriptionfont_size" value="<?php echo $descriptionfont_size;?>" placeholder="<?php esc_attr_e('Enter description font size without px','skt-maintenance'); ?>"></td>
    			</tr>
    			<tr>
    			...
    			<tr>
    				...
    				<td><input type="text" name="footer_text_color" class="color-field" value="<?php echo $footer_text_color; ?>"></td>
    			</tr>
    			<tr>
    				<td><?php esc_attr_e('Footer Text Font Size','skt-maintenance'); ?></td>
    				<td><input type="number" name="footer_textfont_size" value="<?php echo $footer_textfont_size;?>" placeholder="<?php esc_attr_e('Enter footer text font size without px','skt-maintenance'); ?>"></td>
    			</tr>
    			<tr>
					...
					<select name="fontfamily">
					    ...
					    <option <?php if ( esc_attr(get_option('fontfamily') == $value ) ) { ?> selected <?php } ?> value="<?php echo $value; ?>"><?php echo $value; ?></option>
					    <?php } ?>
					    </select>
    				</td>
    			</tr>
    			<tr>
    				...
    				<td><input type="text" name="background_bodycss" class="color-field" value="<?php echo $background_bodycss; ?>"></td>
    			</tr>
    			<tr>
    			...
    			<tr>
    				...
    				<td><input type="text" name="background_overlay_bodycss" class="color-field" value="<?php echo $background_overlay_bodycss; ?>"></td>
    			</tr>
    			<tr>
    				<td><?php esc_attr_e('Background Overlay Opacity','skt-maintenance'); ?></td>
    				<td><input type="number" min="0" max="1" step=".1" name="background_overlay_opc_bodycss" value="<?php echo $background_overlay_opc_bodycss; ?>" placeholder="<?php esc_attr_e('Enter background overlay opacity from 0 to 1','skt-maintenance'); ?>"></td>
    			</tr>
				<tr>
    				<td><?php esc_attr_e('Custom CSS','skt-maintenance'); ?></td>
    				<td><textarea name="custom_css"><?php if($custom_css !=''){echo $custom_css;}?></textarea></td>
    			</tr>
    		</table>
    		<?php submit_button(); ?>
	</form>
...
<?php
  	...
  	$select_maintenancemodeexcludepage = $wpdb->get_results("SELECT* FROM $sktm_maintenance_excludepage");
  	$countrecord = $wpdb->num_rows;

  	if ( !isset( $_POST['add_excludepage'] ) || !wp_verify_nonce($_POST['add_excludepage'], 'excludepage_nonce' ) ){   
    }else{
	  	if($mode=="excludepage"){
	  		$exclude_page_id= implode(',',sktm_maintenance_sanitize_option_field($_POST['exclude_page_id']));
	  		$exclude_post_id = implode(',',sktm_maintenance_sanitize_option_field($_POST['exclude_post_id']));
	  		if($countrecord == '0'){
	  			$insert_query = $wpdb->query("INSERT INTO $sktm_maintenance_excludepage(exclude_page_id,exclude_post_id)values ('$exclude_page_id','$exclude_post_id')");
	  		}else{  			
				$update_query = $wpdb->query("UPDATE $sktm_maintenance_excludepage SET exclude_page_id='$exclude_page_id',exclude_post_id='$exclude_post_id' WHERE ID=1");
	  		}
	  	}
	}
?>
<?php
	$select_exclidepage = $wpdb->get_row("SELECT* FROM $sktm_maintenance_excludepage WHERE ID='1'");
				...
				<table class="skt-maintenance-options-table">
					<tr>
						...
						<select name="exclude_page_id[]" multiple required="">
		                    ...
		                    ?>
		                    <option value="<?php echo $exlude_pagesid;?>" <?php if (in_array($exlude_pagesid, $explode_page_id)){echo "selected";}?>><?php echo $exlude_pagestitle;?></option>
		                    <?php } ?>
	                	</select>
						</td>
					</tr>
					<tr>
						...
						<select name="exclude_post_id[]" multiple required="">
		                    ...
		                    ?>
		                    <option value="<?php echo esc_attr_e($exlude_postsid);?>" <?php if (in_array($exlude_postsid, $explode_post_id)){echo "selected";}?>><?php echo esc_attr($exlude_poststitle);?></option>
		                    <?php } ?>
	                	</select>
						</td>
					</tr>
		...
		<div class="skt-maintenance-options-wrap">
			...
			<div class="skt-themes-row">
				<div class="skt-themes-column">
					<div class="skt-themes-inner">
						<div class="skt-themes-image">
							<img src="<?php echo SKTM_MAINTENANCE_URI.'/images/mountain-biking.jpg'; ?>">
				...
				<div class="skt-themes-column">
					<div class="skt-themes-inner">
						<div class="skt-themes-image">
							<img src="<?php echo SKTM_MAINTENANCE_URI.'/images/skt-tattoo.jpg'; ?>">
				...
				<div class="skt-themes-column">
					<div class="skt-themes-inner">
						<div class="skt-themes-image">
							<img src="<?php echo SKTM_MAINTENANCE_URI.'/images/skt-tailor.jpg'; ?>">
				...
				<div class="skt-themes-column">
					<div class="skt-themes-inner">
						<div class="skt-themes-image">
							<img src="<?php echo SKTM_MAINTENANCE_URI.'/images/motorcycle.jpg'; ?>">
				...
				<div class="skt-themes-column">
					<div class="skt-themes-inner">
						<div class="skt-themes-image">
							<img src="<?php echo SKTM_MAINTENANCE_URI.'/images/school-uniform.jpg'; ?>">
				...
				<div class="skt-themes-column">
					<div class="skt-themes-inner">
						<div class="skt-themes-image">
							<img src="<?php echo SKTM_MAINTENANCE_URI.'/images/event-planners.jpg'; ?>">
				...
				<div class="skt-themes-column">
					<div class="skt-themes-inner">
						<div class="skt-themes-image">
							<img src="<?php echo SKTM_MAINTENANCE_URI.'/images/swimming-pool.jpg'; ?>">
				...
				<div class="skt-themes-column">
					<div class="skt-themes-inner">
						<div class="skt-themes-image">
							<img src="<?php echo SKTM_MAINTENANCE_URI.'/images/skt-aquarium.jpg'; ?>">
				...
				<div class="skt-themes-column">
					<div class="skt-themes-inner">
						<div class="skt-themes-image">
							<img src="<?php echo SKTM_MAINTENANCE_URI.'/images/real-estate.jpg'; ?>">
				...
				<div class="skt-themes-column">
					<div class="skt-themes-inner">
						<div class="skt-themes-image">
							<img src="<?php echo SKTM_MAINTENANCE_URI.'/images/summer-camp.jpg'; ?>">
				...
				<div class="skt-themes-column">
					<div class="skt-themes-inner">
						<div class="skt-themes-image">
							<img src="<?php echo SKTM_MAINTENANCE_URI.'/images/bicycle-shop.jpg'; ?>">
				...
				<div class="skt-themes-column">
					<div class="skt-themes-inner">
						<div class="skt-themes-image">
							<img src="<?php echo SKTM_MAINTENANCE_URI.'/images/skt-association.jpg'; ?>">
				...
				<div class="skt-themes-column">
					<div class="skt-themes-inner">
						<div class="skt-themes-image">
							<img src="<?php echo SKTM_MAINTENANCE_URI.'/images/skt-municipality.jpg'; ?>">
				...
				<div class="skt-themes-column">
					<div class="skt-themes-inner">
						<div class="skt-themes-image">
							<img src="<?php echo SKTM_MAINTENANCE_URI.'/images/flower-shop.jpg'; ?>">
				...
				<div class="skt-themes-column">
					<div class="skt-themes-inner">
						<div class="skt-themes-image">
							<img src="<?php echo SKTM_MAINTENANCE_URI.'/images/complete-pro.jpg'; ?>">
